...
\EducationEntry{Bachelor of Fine Arts}{2003-2009}{School of Visual Arts, NY}{BFA, 2010 upon transfer of science and math credits.
Double Major: Cartooning & Fine Arts.Dean's List 2006-2009.Descriptive text goes here. In order to maintain a stylish look, try to fill this description with a few lines of text. Do the same for the other entries in the education section.}
\sepspace
...
\SkillsEntry{Software}{\textsc{Matlab}, \LaTeX, \textsc{Ansys}, \textsc{Comsol}, \textsc{Python}}

\SkillsEntry{Programming Languages}{\textsc{PHP}, \textsc{node.js} and \textsc{npm} and \textsc{yarn}}
